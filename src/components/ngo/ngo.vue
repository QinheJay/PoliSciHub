...
<template>
    <div class="container" v-if="render">
        ...
        <n-modal v-model:show="showDetailModal" style="width: 720px" preset="card" size="huge" :bordered="false"
                    ...
                    <n-grid :cols="2" class="ngoCard__content" :x-gap="24" :y-gap="24">
                        ...
                        <n-gi>
                            ...
                            <div v-if="curNgo.email">
                                <n-ellipsis line-clamp="1">{{ curNgo.email }}</n-ellipsis>
                            </div>
                            <div v-else>
                                <n-skeleton text :animated="false" style="width: 50%" />
                            </div>
                        ...
                        <n-gi>
                            ...
                            <div v-if="curNgo.website" class="textClick" @click="openWebsite(curNgo.website)">
                                <n-ellipsis line-clamp="1"><u>{{ curNgo.website }}</u></n-ellipsis>
                            </div>
                            <div v-else>
                        ...
                        <n-gi>
                            ...
                            <div v-if="curNgo.type">
                                <n-ellipsis line-clamp="1">{{ curNgo.type }}</n-ellipsis>
                            </div>
                            <div v-else>
                                <n-skeleton text :animated="false" style="width: 50%" />
                            </div>
